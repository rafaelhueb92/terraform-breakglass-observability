...
See the [troubleshooting guide](troubleshooting/README.md) for QuickSight setup, permissions, DNS, Athena returning 0 rows, Firehose `Lambda.InvokeAccessDenied`, Firehose buffering size, and Firehose data-format conversion errors.

## Architecture 🏗️

![Break-Glass Observability architecture](images/architecture.jpeg)

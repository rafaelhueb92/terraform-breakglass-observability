...
See the [troubleshooting guide](troubleshooting/README.md) for QuickSight setup, permissions, DNS, Firehose `Lambda.InvokeAccessDenied`, Firehose buffering size, and Firehose data-format conversion errors.
